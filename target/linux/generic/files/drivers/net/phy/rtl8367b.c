...
static int rtl8367b_init_regs(struct rtl8366_smi *smi)
{
	...
	case RTL8367B_CHIP_UNKNOWN_RLVID0:
		initvals = rtl8367r_vb_initvals_0;
		count = ARRAY_SIZE(rtl8367r_vb_initvals_0);
		break;
	case RTL8367B_CHIP_UNKNOWN_RLVID1:
				  ...
				  const char *name)
{
	...
	if ((smi->rtl8367b_chip <= RTL8367B_CHIP_RTL8367RB_VB) && (cfg->ability.speed > RTL8367B_SPEED_1000)) /* Family B and C */
...
static int rtl8367b_detect(struct rtl8366_smi *smi)
{
	...
	if (!chip_name) {
		...
		switch (rlvid) {
		case 0:
			smi->rtl8367b_chip = RTL8367B_CHIP_UNKNOWN_RLVID0;
			break;
		case 1:
			smi->rtl8367b_chip = RTL8367B_CHIP_UNKNOWN_RLVID1;
			break;
		default:
