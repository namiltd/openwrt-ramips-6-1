...
define KernelPackage/phy-aquantia
  ...
  DEPENDS:=+kmod-libphy +kmod-hwmon-core +LINUX_6_6:kmod-lib-crc-ccitt +LINUX_6_12:kmod-lib-crc-itu-t
...
define KernelPackage/iavf
  ...
  DEPENDS:=@PCI_SUPPORT +LINUX_6_12:kmod-libeth +LINUX_6_12:kmod-libie
  KCONFIG:= \
       CONFIG_I40EVF \
       CONFIG_IAVF
  FILES:= \
...
define KernelPackage/lan743x
  ...
  DEPENDS:=@PCI_SUPPORT +kmod-ptp +kmod-mdio-devres +kmod-fixed-phy +LINUX_6_12:kmod-phylink
